...
Admin dashboard 
--------------------------
- adjust the template with the details needed
e.g. total cases, total cases done, total cases ongoing -->
		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				...
				<div class="card-box pb-10">
                    ...
                    <!-- waiting for Part 2 Manage Cases
                    use list of tasks for now -->
