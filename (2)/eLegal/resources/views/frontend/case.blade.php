...
<head>
	...
	<title>Case Page</title>
		...
		<link rel="stylesheet" type="text/css" href="vendors/styles/alya.css"/>
	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="card-box mb-30">
				<div class="pd-20">
					<h4 class="text-blue h4">Cases</h4>
					<a href="" data-toggle="modal" data-target="#modal" class="btn btn-primary btn-sm float-right" type="button">
						<i class="icon-copy dw dw-add"></i> Add Case
					</a>
				</div>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<div class="modal-header">
							<h5 class="modal-title" id="modalLabel">Add Case</h5>
						</div>
						...
						<div class="modal-body">
							<form>
								<div class="form-group row">
									<!-- should auto generate the Case ID-->
									<label class="col-sm-12 col-md-2 col-form-label">Case ID</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control" type="text" placeholder="Case ID">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-sm-12 col-md-2 col-form-label">Added Date</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control" type="date" placeholder="AddedDate">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-12 col-md-10">
										<input class="form-control" type="date" placeholder="DueDate">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-sm-12 col-md-2 col-form-label">Court Hearing Date</label>
									<div class="col-sm-12 col-md-10">
										<input class="form-control" type="date" placeholder="CHDate">
									</div>
								</div>
			...
			<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<!-- Body -->
						<!-- initial user info should already be shown -->
						<div class="modal-body">
							<form>
								<div class="form-group row">
									<!-- should auto generate the Case ID-->
			...
			<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<!-- Header -->
						<div class="modal-header">
							<h5 class="modal-title" id="modalLabel">Delete Staff</h5>
						</div>
				...
				<div class="pb-20">
					<table class="data-table table stripe hover nowrap">
						<thead>
							<tr>
								<th class="table-plus datatable-nosort">Case ID</th>
			...
			<!-- Footer -->
			<div class="footer-wrap pd-20 mb-20 card-box">e-Legal @ CMT322 23/24</div>
		</div>
	</div>
